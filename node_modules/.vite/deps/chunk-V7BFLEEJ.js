...
var _excluded5 = ["className", "disabled", "disableFocusRipple", "fullWidth", "icon", "iconPosition", "indicator", "label", "onChange", "onClick", "onFocus", "selected", "selectionFollowsFocus", "textColor", "value", "wrapped"];
...
var Tab = React7.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime8.jsxs)(React7.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime8.jsxs)(React7.Fragment, {
      children: [label, icon]
    }), indicator]
  }));
});
true ? Tab.propTypes = {
   ...
   * The icon to display.
   */
  icon: import_prop_types5.default.oneOfType([import_prop_types5.default.element, import_prop_types5.default.string]),
  /**
   * The position of the icon relative to the label.
   * @default 'top'
   */
  iconPosition: import_prop_types5.default.oneOf(["bottom", "end", "start", "top"]),
  /**
   * The label element.
   */
   ...
   * @default false
   */
  wrapped: import_prop_types5.default.bool
} : void 0;
var Tab_default = Tab;
...
var _excluded6 = ["className", "slots", "slotProps", "direction", "orientation", "disabled"];
...
var TabScrollButton = React8.forwardRef(function TabScrollButton2(inProps, ref) {
...
true ? TabScrollButton.propTypes = {
   ...
   */
  direction: import_prop_types6.default.oneOf(["left", "right"]).isRequired,
  /**
   * If `true`, the component is disabled.
   * @default false
   */
  ...
  slotProps: import_prop_types6.default.shape({
    endScrollButtonIcon: import_prop_types6.default.oneOfType([import_prop_types6.default.func, import_prop_types6.default.object]),
    startScrollButtonIcon: import_prop_types6.default.oneOfType([import_prop_types6.default.func, import_prop_types6.default.object])
  }),
  /**
   * The components used for each slot inside.
   * @default {}
  ...
  slots: import_prop_types6.default.shape({
    EndScrollButtonIcon: import_prop_types6.default.elementType,
    StartScrollButtonIcon: import_prop_types6.default.elementType
  }),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var _excluded8 = ["aria-label", "aria-labelledby", "action", "centered", "children", "className", "component", "allowScrollButtonsMobile", "indicatorColor", "onChange", "orientation", "ScrollButtonComponent", "scrollButtons", "selectionFollowsFocus", "slots", "slotProps", "TabIndicatorProps", "TabScrollButtonProps", "textColor", "value", "variant", "visibleScrollbar"];
...
true ? Tabs.propTypes = {
   ...
   * @default false
   */
  allowScrollButtonsMobile: import_prop_types8.default.bool,
  /**
   ...
   * @default false
   */
  centered: import_prop_types8.default.bool,
  /**
   * The content of the component.
   */
   ...
   * @default 'primary'
   */
  indicatorColor: import_prop_types8.default.oneOfType([import_prop_types8.default.oneOf(["primary", "secondary"]), import_prop_types8.default.string]),
  /**
   ...
   */
  ScrollButtonComponent: import_prop_types8.default.elementType,
  /**
   ...
   * @default 'auto'
   */
  scrollButtons: import_prop_types8.default.oneOf(["auto", false, true]),
  /**
   * If `true` the selected tab changes on focus. Otherwise it only
   * changes on activation.
   */
  selectionFollowsFocus: import_prop_types8.default.bool,
  /**
   * The extra props for the slot components.
   * You can override the existing props or add new ones.
   * @default {}
   ...
   * @default  {}
   */
  TabIndicatorProps: import_prop_types8.default.object,
  /**
   * Props applied to the [`TabScrollButton`](/material-ui/api/tab-scroll-button/) element.
   * @default {}
   */
  TabScrollButtonProps: import_prop_types8.default.object,
  /**
   * Determines the color of the `Tab`.
   * @default 'primary'
   */
  textColor: import_prop_types8.default.oneOf(["inherit", "primary", "secondary"]),
  /**
   ...
   * @default 'standard'
   */
  variant: import_prop_types8.default.oneOf(["fullWidth", "scrollable", "standard"]),
  /**
   * If `true`, the scrollbar is visible. It can be useful when displaying
   * a long vertical list of tabs.
   * @default false
   */
  visibleScrollbar: import_prop_types8.default.bool
} : void 0;
...
//# sourceMappingURL=chunk-V7BFLEEJ.js.map
